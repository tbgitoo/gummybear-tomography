...
The filestructure should after download should integrate both the structure from this repository 
and the Huggingface checkpoints and dataset (unless you want to generate it yourself, then
...
├── checkpoints/                    # Can be downloaded from Huggingface (or generated).
│   ├── m8/
...
│
├── data/                                 # From Huggingface (or generated)
...
├── test/                          # Implementation plans, this repository
...
```
